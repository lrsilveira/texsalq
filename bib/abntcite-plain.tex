...
\ifx\ABCIccomma\@undefined
   \long\def\ABCIccomma{}
\fi
\long\def\ABCIcitecommadefault{; }%{,\penalty\@m\ } Esalq standard always uses semicolon in both implicit and explicit citations!
...
\ifx\AbntCitetype\AbntCitetypeALF % if alf
 ...
 \def\cite[#1]{\let\citeseptype\ABCIcitecolondefault% Setting the variable before anything
              {\citeA#1,,,\citeopen\printsavedcites\citeclose}%
              }%
 ...
 \def\citeonline[#1]{\let\citeseptype\ABCIcitecommadefault% Setting the variable before anything
                    {\citeonlineA#1,,,\printsavedcites}%
                    }%
